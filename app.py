...
q_expectativas = st.text_area("¿Cuál es la visión de éxito y las expectativas de experiencia (ej. simplicidad de conexión, paridad entre remotos y presenciales, o innovación tecnológica) que sus colaboradores demandan para que el trabajo en la oficina sea percibido como un valor agregado?")
